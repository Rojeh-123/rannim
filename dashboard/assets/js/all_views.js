...
document.addEventListener('click', e => {
  ...
  if (bellBtn && notifPopup && !bellBtn.contains(e.target) && !notifPopup.contains(e.target)) {
    notifPopup.classList.remove('show');
  }
  if (profileBtn && profilePopup && !profileBtn.contains(e.target) && !profilePopup.contains(e.target)) {
