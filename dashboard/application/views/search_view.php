    ...
    <div class="main-content">
      <div class="container text-center mt-4">
        <div class="card-search latin"><a class="text-white" style="text-decoration:none;" href="<?php echo site_url("Rannim/show_all_admins"); ?>">Admins</a></div>
        ...
        <div class="card-search madeforyou"><a class="text-white" style="text-decoration:none;" href="<?php echo site_url("Rannim/show_all_countries"); ?>">Countries</a></div>
        ...
        <div class="card-search pop"><a class="text-white" style="text-decoration:none;" href="<?php echo site_url("Rannim/show_all_lyrics"); ?>">Songs Lyrics</a></div>
...
<script>
  ...
  search.href = '<?php echo base_url(); ?>assets/css/search.css';
