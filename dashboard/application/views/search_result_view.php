    ...
    <div class="container-fluid mt-3">
      ...
      <div class="d-flex justify-content-between align-items-center my-3 mt-2">
        <h3>Artists</h3>
        <a href="<?php echo site_url('Rannim/show_all_artists'); ?>" class="text-decoration-none text-secondary">View all</a>
      </div>
      <div class="row g-3">
                    ...
                    <div class="card card-custom h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-secondary">
                                <img src="<?php echo base_url(); ?>assets/uploads/countries_flags/<?php echo $artist->country_flag; ?>" alt="Country Flag" class="me-1" style="width:16px;height:12px;">
