          ...
          <div class="col-md-4">
            <a href="<?php echo site_url("Rannim/show_one_playlist/$playlist->playlist_id"); ?>" style="text-decoration:none;">
              <div class="card card-custom h-100">
                  ...
                  <div>
                    <button class="btn btn-sm btn-outline-danger mt-2"><a href="<?php echo site_url("Rannim/delete_playlist/$playlist->playlist_id/$playlist->playlist_photo"); ?>" style="text-decoration:none; color:inherit;">Delete</a></button>
                  </div>
                  </div>
              </div>
            </a>
