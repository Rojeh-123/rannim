            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card p-4">
                        ...
                        <form action="<?php echo site_url("Rannim/update_one_song") ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="category" value="<?php echo $song->category_id; ?>">
                            <input type="hidden" name="type" value="<?php echo $song->type_id; ?>">
