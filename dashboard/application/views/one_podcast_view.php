      ...
      <div class="main-content">
        <div class="song-view">
          <div class="song-info text-center">
            <img src="<?php echo base_url(); ?>assets/uploads/podcasts_photos/<?php echo $podcast->podcast_thumbnail ?>" alt="Podcast Image" class="song-img rounded mb-3" style="max-width:300px;">
          ...
          <div class="audio-container text-center mb-3">
            <audio id="audio" src="<?php echo base_url(); ?>assets/uploads/podcasts_files/<?php echo $podcast->podcast_file ?>"></audio>
        ...
        <!-- Download -->
        <a href="<?php echo base_url(); ?>assets/uploads/podcasts_files/<?php echo $podcast->podcast_file ?>" download class="option-btn" title="Download this song">
...
<script src="<?php echo base_url(); ?>assets/js/one_podcast.js"></script>
<script>
