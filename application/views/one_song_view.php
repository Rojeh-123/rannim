    <div class="main-content d-flex justify-content-center">
      <div class="song-view">
        ...
        <div class="song-info">
          <img src="<?php echo base_url(); ?>dashboard/assets/uploads/songs_photos/<?php echo $song->song_photo ?>" alt="Song Image" class="song-img">
          <h2 class="song-title mt-3"><?php echo $song->title ?></h2>
        </div>

        <div class="audio-container">
          <audio id="audio" src="<?php echo base_url(); ?>dashboard/assets/uploads/songs_sounds/<?php echo $song->song_file ?>"></audio>
        ...
        <!-- Download -->
        <a href="<?php echo base_url(); ?>dashboard/assets/uploads/songs_sounds/<?php echo $song->song_file ?>" download class="option-btn" title="Download this song">
...
<script src="<?php echo base_url(); ?>dashboard/assets/js/one_song.js"></script>
<script>
