...
<head>
  ...
  <link href="<?php echo base_url(); ?>dashboard/assets/css/login.css" rel="stylesheet">
  <title>Rannim | Login</title>
</head>
<body>
  <div class="login-page">
    <div class="login-card shadow-sm" role="main" aria-labelledby="login-title">
      <img src="<?php echo base_url(); ?>dashboard/assets/img/logo_only.png" alt="Rannim Logo" class="login-logo" />
      ...
      <form class="form" id="login-form" novalidate method="post" action="<?php echo site_url('Rannim/log_user_in'); ?>">
      ...
      <div class="signup-section mt-4">
        ...
        <a href="<?php echo site_url("Rannim/register_view"); ?>" class="signup-link">Sign Up</a>
      </div>
    </div>
  </div>
