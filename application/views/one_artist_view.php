    ...
    <div class="container-fluid mt-3">
      ...
      <div class="cover-photo" style="background-image:url('https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?q=80&w=1200');">
        <div class="profile-photo">
          <img src="<?php echo base_url(); ?>dashboard/assets/uploads/artists_photos/<?php echo $artist->artist_photo ?>" alt="Artist Photo">
        </div>
      </div>
        ...
        <?php foreach($songs as $song){ ?>
            <li class="song-item">
                ...
                <div class="song-controls">
                    <a href="<?php echo base_url(); ?>dashboard/assets/uploads/songs_sounds/<?php echo $song->song_file ?>" download title="Download" class="btn-song">
                    <img src="<?php echo base_url(); ?>dashboard/assets/img/download-button.png" alt="Download">
                    </a>
                    <button class="btn-song" title="Share" 
                        ...
                        <img src="<?php echo base_url(); ?>dashboard/assets/img/share.png" alt="Share">
                    </button>
                </div>
                <audio src="<?php echo base_url(); ?>dashboard/assets/uploads/songs_sounds/<?php echo $song->song_file ?>" preload="metadata"></audio>
            </li>
        <?php } ?>
      </ul>
    </div>
...
<script>
  ...
  one_artist.href = '<?php echo base_url(); ?>dashboard/assets/css/one_artist.css';
